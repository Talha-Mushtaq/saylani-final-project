                 ...
                 <Container>
                      <Row>
                        ...
                        */}
                        ...
                        <Link to='/Admin_Login' className='Nav'><i class="fa fa-user-o" aria-hidden="true"></i></Link> 
                        <Link to='/Cards' className='Nav'style={{float:"right"}}>My Cart</Link> 
                        <Link to='/' className='Nav' style={{float:"right"}}>Home</Link>
                        </Col>
                      </Row>
                    </Container>          
            </Toolbar>
